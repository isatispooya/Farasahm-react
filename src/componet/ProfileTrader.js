...
import { BsPersonCircle , BsCalendar2Date , BsPinMap , BsHash} from "react-icons/bs";
...
const ProfileTrader = (props) =>{
    ...
    const getProfileTRader = ()=>{
        if (props.dataProfile) {
            axios({method:'POST',url:OnRun+'/getprofiletrader',data:{code:props.dataProfile,access:props.access}
            }).then(response=>{
