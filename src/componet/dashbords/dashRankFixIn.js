...
const DashRnkFixIn = () => {
  ...
  const get = () => {
    axios.post(OnRun + "/getrankfixin", { access: access }).then((response) => {
            ...
            <div className="meter">
              <p
                style={{
                  marginLeft:
                    (
                      (1 - dic.ret_ytm_7 / dic.ret_ytm_7_count) *
                      100
                    ).toString() + "%",
                }}
              >
            ...
            <div className="meter">
              <p
                style={{
                  marginLeft:
                    (
                      (1 - dic.ret_ytm_14 / dic.ret_ytm_14_count) *
                      100
                    ).toString() + "%",
                }}
              >
            ...
            <div className="meter">
              <p
                style={{
                  marginLeft:
                    (
                      (1 - dic.ret_ytm_30 / dic.ret_ytm_30_count) *
                      100
                    ).toString() + "%",
                }}
              >
            ...
            <div className="meter">
              <p
                style={{
                  marginLeft:
                    (
                      (1 - dic.ret_ytm_90 / dic.ret_ytm_90_count) *
                      100
                    ).toString() + "%",
                }}
              >
            ...
            <div className="meter">
              <p
                style={{
                  marginLeft:
                    (
                      (1 - dic.ret_ytm_180 / dic.ret_ytm_180_count) *
                      100
                    ).toString() + "%",
                }}
              >
            ...
            <div className="meter">
              <p
                style={{
                  marginLeft:
                    (
                      (1 - dic.ret_ytm_365 / dic.ret_ytm_365_count) *
                      100
                    ).toString() + "%",
                }}
              >
            ...
            <div className="meter">
              <p
                style={{
                  marginLeft:
                    (
                      (1 - dic.ret_ytm_730 / dic.ret_ytm_730_count) *
                      100
                    ).toString() + "%",
                }}
              >
