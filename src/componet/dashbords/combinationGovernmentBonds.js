...
const CombineGovernment = () => {
  ...
  const get = () => {
    axios
      .post(OnRun + "/getassetmixoraqdol", { access: access })
      .then((response) => {
  ...
  const Options = {
    ...
    plugins: {
      legend: {
        display: true,
        title: { display: false, text: "ترکیب اوراق دولتی" },
  ...
  return (
    <div className="my-5">
      <h1 className="">ترکیب اوراق دولتی</h1>
      <div className="flex justify-between mx-10 items-center">
        <div className="my-5">
          <div className="flex flex-col bg-green-600 ring-1 ring-green-600 py-3 items-center my-5 px-10  rounded-lg bg-opacity-35 ">
            <h4 className="font-bold text-xl">بازدهی</h4>
            <p className="text-base font-medium">
              {rate === null ? <MiniLoader /> : rate}%
            </p>
          </div>
          <div className="flex flex-col bg-green-600 ring-1 ring-green-600 py-3 items-center  px-10  rounded-lg bg-opacity-35 ">
...
export default CombineGovernment;
