...
const BrokerActivityReport = () =>{
    const {code} = useParams()
    const [brokerSelect, setBrokerSelect] = useState(code)
    ...
    return(
        <div className="subPage tablePg">
            <div className="tls">
                <h2 className="titlePage">گزارش فعالیت کارگزاری {brokerSelect}</h2>
...
export default BrokerActivityReport