...
const FormerStockman = () =>{
    ...
    if(df!=null && dic!=null){
        ...
        var table = new Tabulator("#data-table", {
            ...
            columns:[
                ...
                {title:"درصد", field:"rate", hozAlign:'center',headerHozAlign:'center',resizable:true, widthGrow:3,headerFilter:"input",topCalc:"sum",
                topCalcFormatter:function(cell, formatterParams){
                    var value = cell.getValue();
                    return("<p>"+ (value*1).toLocaleString()+"%</p>")
                },
    ...
    const getDf = ()=>{
        ...
        setDf(null)
        axios({method:'POST',url:OnRun+'/getformerstockman',data:{access:access}
        }).then(response=>{
